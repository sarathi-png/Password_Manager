...
- Mobile: Flutter `mobile/lib/api.dart:22` `defaultServer = https://vault-lcgd.onrender.com` — override via login screen for LAN testing (`http://<host>:8000` with `android:usesCleartextTraffic="true"` already set).
